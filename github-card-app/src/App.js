...
class App extends React.Component {
  ...
  fetchProfile = username => {
    ...
    fetch(url)
      ...
      .catch(error => console.log("Sorry !!! This is wrong username"));
  };
  ...
  render() {
    return (
      <div>
        ...
        <span className="thechiefalone">
          Github Card with React - Created by{" "}
          <a href="https://github.com/thechiefalone" target="_blank">
            thechiefalone
          </a>
        </span>
      </div>
    ...
    if (data.notFound === "Not Found")
      return (
        <div className="notfound">
          <h2>Oopss !!!</h2>
          <p>The Application Couldn't Find The User You Are Looking For</p>
        </div>
      );
    else
      return (
